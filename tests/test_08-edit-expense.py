...
@pytest.fixture(scope='function')
def user1(client):
    """Create first user and return user_id."""
...
@pytest.fixture(scope='function')
def user2(client):
    """Create second user and return user_id."""
    client.post('/register', data={
        'name': 'User Two',
...
class TestEditExpenseRouteGET:
    ...
    def test_get_edit_expense_authenticated_own_expense(self, client, user1):
        ...
        assert 'value="2026-08-15"' in html
        assert 'value="Lunch"' in html
        assert '<option value="Food" selected>' in html

    def test_get_edit_expense_authenticated_other_user(self, client, user1, user2):
    ...
    def test_get_edit_expense_authenticated_non_existent(self, client, user1):
...
class TestEditExpenseRoutePOST:
    ...
    def test_post_edit_expense_authenticated_valid(self, client, user1):
    ...
    def test_post_edit_expense_authenticated_other_user(self, client, user1, user2):
        """POST /expenses/<id>/edit returns 404 when user tries to update another user's expense."""
        expense_id = insert_expense(user1, 100.0, 'Food', '2026-08-15', 'Lunch')

        # Login as user2 and try to update user1's expense
        client.post('/login', data={
            'email': 'user2@test.com',
            'password': 'pass456'
        })
    ...
    def test_post_edit_expense_authenticated_missing_amount(self, client, user1):
        ...
        assert response.status_code == 200
        html = response.get_data(as_text=True)
        assert 'Please enter a valid amount' in html

    def test_post_edit_expense_authenticated_amount_zero(self, client, user1):
    ...
    def test_post_edit_expense_authenticated_non_numeric_amount(self, client, user1):
    ...
    def test_post_edit_expense_authenticated_invalid_category(self, client, user1):
    ...
    def test_post_edit_expense_authenticated_invalid_date(self, client, user1):
    ...
    def test_post_edit_expense_authenticated_no_description(self, client, user1):
